...
$changelog = [
    '1.3.3' => [
        'date' => '2026-04-26',
        'items' => [
            '<strong>Agências:</strong> Correção na geração de token/senha.',
            '<strong>Agências:</strong> Botões copiar link/senha funcionando.',
            '<strong>Agências:</strong> Correção rota select-client (404).',
            '<strong>Agências:</strong> Layout dados da agência corrigido.',
            '<strong>Portal:</strong> Troca de cliente via dropdown funcionando.',
        ]
    ],
    '1.3.2' => [
        'date' => '2026-04-26',
        'items' => [
            '<strong>Agências:</strong> Login de agência no portal.',
            '<strong>Agências:</strong> Troca de cliente dentro do portal.',
            '<strong>Agências:</strong> Uma senha para acessar todos os clientes.',
        ]
    ],
    '1.3.1' => [
        'date' => '2026-04-26',
    ...
    '1.2.5' => [
        'date' => '2026-04-25',
        'items' => [
            '<strong>API:</strong> Filtrar tarefas por usuário e status.',
        ]
    ],
    '1.2.4' => [
        'date' => '2026-04-25',
